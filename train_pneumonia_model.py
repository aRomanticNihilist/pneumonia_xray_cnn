...
from tensorflow.keras.callbacks import LearningRateScheduler, EarlyStopping, LambdaCallback  # type: ignore
import logging
...
parser.add_argument(
    "--log_file", type=str, required=True, help="Log file to store output"
)
